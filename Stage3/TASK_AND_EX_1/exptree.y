...
%type <no> expr program stmt slist inputstmt outputstmt assgstmt ifstmt whilestmt
%token <no> NUM ID READ WRITE
%token PLUS MINUS MUL DIV END BEGN LT GT LE GE NE EQ IF THEN ELSE ENDIF WHILE DO ENDWHILE

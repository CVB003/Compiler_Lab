enum nodetype{ps,ms,ml,dv,mod,rd,wr,cnn,id,num,str_const,asg,ne,eq,lt,gt,ge,le,whl,el,ifel,brek,cont,intnd,strnd,varlst,declst,arr2ddecl,arr2dval,arr2dasg,decl,rpt,dow,arrval,arrasg,arrdecl};

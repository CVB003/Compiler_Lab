...
Typedefblock Typedeflist Typedef Fielddeclist Fielddecl ClassDefBlock ClassDefList ClassDef Cname MethodDecl MDecl MethodDefns MDef 
%token <no> NUM ID READ WRITE BREAK CONTINUE INT STR STRING SELF BRKPND
%token PLUS MINUS MUL DIV END BEGN LT GT LE GE NE EQ IF THEN ELSE ENDIF WHILE DO ENDWHILE DECL ENDDECL REPEAT UNTIL MAIN RETURN AND TYPE ENDTYPE ALLOC NULL_SPL FREE INITIALIZE CLASS ENDCLASS EXTENDS DELETE NEW
...
program : Typedefblock ClassDefBlock Gdeclblock Fdefblock Mainblock	{
						struct tnode* t1=createTree(-1,"void","",cnn,$4,$5);
						 $$=createTree(-1,"void","",cnn,$3,t1);
						printf("\n Printing symbol table\n");
						  struct Gsymbol* t=symbtable;
						  symbtable=NULL;
						 add_funcdefs_class($2);
						 symbtable=t;
							
						  }
	 | Typedefblock ClassDefBlock Gdeclblock Mainblock			{ $$=createTree(-1,"void","",cnn,$3,$4);
	 					 printf("\n Printing symbol table\n");
						  struct Gsymbol* t=symbtable;
						  symbtable=NULL;
						 add_funcdefs_class($2);
...
Gdecl : type Gidlist ';'	{assign_type($2,$1->varname);$$=createTree(-1,"void","",gdecl,$1,$2);}
	;
...
ClassDefBlock : CLASS ClassDefList ENDCLASS {$$=$2;}
    		| CLASS ENDCLASS {$$=NULL;}
    		;
ClassDefList : ClassDefList ClassDef {$$=createTree(-1,"void","",classdeflst,$1,$2);}
               | ClassDef	{$$=$1;}
		;
 
ClassDef : Cname '{' DECL Fielddeclist MethodDecl ENDDECL MethodDefns '}' {$$=createTree(-1,"void","",classdef,$1,createTree(-1,"void","",cnn,$4,createTree(-1,"void","",cnn,$5,$7)));}
	  | Cname '{' DECL MethodDecl ENDDECL MethodDefns '}' {$$=createTree(-1,"void","",classdef,$1,createTree(-1,"void","",cnn,NULL,createTree(-1,"void","",cnn,$4,$6)));}
	  ;
	 
Cname : ID {$$=createTree(-1,"void","",cnamend,$1,NULL);}
	| ID EXTENDS ID	{$$=createTree(-1,"void","",cnamend,$1,$3);}
	;

MethodDecl : MethodDecl MDecl {$$=createTree(-1,"void","",mdeclst,$1,$2);}
	   | MDecl {$$=$1;}
	   ;
MDecl : type ID '(' Paramlist ')' ';'{$$=createTree(-1,"void","",mdecl,$1,createTree(-1,"void","",cnn,$2,$4));}
       | type ID '(' ')' ';' {$$=createTree(-1,"void","",mdecl,$1,createTree(-1,"void","",cnn,$2,NULL));}
	;

MethodDefns : MethodDefns MDef {$$=createTree(-1,"void","",mdeflst,$1,$2);}
            | MDef {$$=$1;}
	    ;
MDef :  type ID '(' Paramlist ')' '{' Ldeclblock body '}' {$$=createTree(-1,"void","",mdef,$1,createTree(-1,"void","",cnn,$2,createTree(-1,"void","",cnn,$4,createTree(-1,"void","",cnn,$7,$8))));}
	| type ID '(' ')' '{' Ldeclblock body '}'	{$$=createTree(-1,"void","",mdef,$1,createTree(-1,"void","",cnn,$2,createTree(-1,"void","",cnn,NULL,createTree(-1,"void","",cnn,$6,$7))));}
	;
...
Field: Field '.' ID {$$=createTree(-1,"void","",fieldlst,$1,$3);}
	...
	| SELF '.' ID {$$=createTree(-1,"void","",self_field,$1,$3);}
	;
...
stmt : inputstmt	{$$ = $1;}
       ...
       | dowhilestmt	{$$=$1;}
       | retstmt	{$$=$1;}
       | DELETE '(' ID ')' ';' {$$=createTree(-1,"void","",delnd,$3,NULL);}
       | BRKPND ';' {$$=$1;}
       ;
...
expr : expr PLUS expr		{$$ = createTree(-1,"INT","",ps,$1,$3);}
	 ...
	 | Field '(' Arglist ')' {$$=createTree(-1,"void","",metcall,$1,$3);}
	 | Field '(' ')'	{$$=createTree(-1,"void","",metcall,$1,NULL);}
	 | Field	{$$=createTree(-1,"void","",fieldval,$1,NULL);}
	 | INITIALIZE '(' ')'	{$$=createTree(-1,"INT","",initnd,NULL,NULL);printf("reachinf here for newnd.....\n");}
	 ...
	 | NEW '(' ID ')' {printf("reachinf here for newnd.....\n");$$=createTree(-1,"void","",newnd,$3,NULL);}
	 ;

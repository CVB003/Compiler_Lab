enum nodetype{ps,ms,ml,dv,mod,rd,wr,cnn,id,num,str_const,asg,asg2,ne,eq,andnd,brkp,tupasg,tupval,tuplst,tupdecl,tupdecl_ldecl,lt,gt,ge,le,whl,el,ifel,brek,cont,intnd,strnd,varlst,ldecl,ldecllst,ldeclblk,mainnd,retnd,fncall,arglst,fdefblk,fndef,idlst,gdeclblk,gdecl,gdeclst,gidlst,funcdecl,paramlst,param,rpt,dow,arrval,arrasg,arrdecl,addr_id,ptrfuncdecl,ptrasg,ptrdecl,ptrval};
enum type{inttype,booltype,strtype,notype,intptrtype,strptrtype,tuptype};

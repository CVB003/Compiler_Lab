...
%type <no> expr program stmt slist inputstmt outputstmt assgstmt ifstmt whilestmt repeatstmt dowhilestmt type Gdeclblock Fdefblock Mainblock Gdecllist Gdecl Gidlist Gid Fdef Paramlist Param Ldecllist Ldeclblock Ldecl Idlist body retstmt Arglist tup_var_list

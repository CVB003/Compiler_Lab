enum nodetype{ps,ms,ml,dv,mod,rd,wr,cnn,id,num,str_const,asg,asg2,ne,eq,andnd,lt,gt,ge,le,whl,el,ifel,brek,cont,intnd,strnd,varlst,ldecl,ldecllst,ldeclblk,mainnd,retnd,fncall,arglst,fdefblk,fndef,idlst,gdeclblk,gdecl,gdeclst,gidlst,funcdecl,paramlst,param,rpt,dow,arrval,arrasg,arrdecl,addr_id,ptrfuncdecl,ptrasg,ptrdecl,ptrval};
